...
public class CarController {
    ...
    public ResponseEntity<CarDTO> addCar(@RequestBody CarDTO carDTO) {
        ...
        String brandUrl = "http://brands-app:8081/brands/" + carDTO.getBrandId();
        ...
        String addCarUrl =  "http://brands-app:8081/brands/" + carDTO.getBrandId() + '/' + car.getId().toString();
    ...
    public ResponseEntity<CarDTO> editCar(@PathVariable UUID uuid, @RequestBody CarDTO carDTO) {
        ...
        if (!oldBrandId.equals(car.getBrandId())) {
            ...
            String removeCarUrl =  "http://brands-app:8081/brands/" + oldBrandId + '/' + car.getId().toString();
            RestTemplate restTemplate = new RestTemplate();
